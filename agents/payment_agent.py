...
numbers. The configured Qwen model is only used for an optional
...
from shared.constants import MODEL_NAME, RECONCILIATION_TOLERANCE_BRL
...
class PaymentAgent:
    ...
    def __init__(self, model_client: QwenModelClient | None = None):
    ...
    def explain(self, order_id: str, item_total_brl: float, freight_total_brl: float) -> str:
        ...
        return self._client.generate(
            [{"role": "user", "content": prompt}], max_new_tokens=60
        )
